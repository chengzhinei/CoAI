...
func (*MsgUpdateParams) Descriptor() ([]byte, []int) {
	return fileDescriptor_411f6f4337dd0381, []int{0}
}
...
func (*MsgUpdateParamsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_411f6f4337dd0381, []int{1}
}
...
func init() {
	proto.RegisterType((*MsgUpdateParams)(nil), "coai.coai.MsgUpdateParams")
	proto.RegisterType((*MsgUpdateParamsResponse)(nil), "coai.coai.MsgUpdateParamsResponse")
}

func init() { proto.RegisterFile("coai/coai/tx.proto", fileDescriptor_411f6f4337dd0381) }

var fileDescriptor_411f6f4337dd0381 = []byte{
	// 333 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0x12, 0x4a, 0xce, 0x4f, 0xcc,
	...
	0x32, 0x4a, 0x93, 0xf4, 0x92, 0xf3, 0x73, 0xf5, 0x73, 0x2b, 0x4b, 0x8b, 0x53, 0x8b, 0xf4, 0x9d,
	0xf3, 0x1d, 0x3d, 0x61, 0x3e, 0x28, 0xa9, 0x2c, 0x48, 0x2d, 0x4e, 0x62, 0x03, 0x07, 0xb8, 0x31,
	0x20, 0x00, 0x00, 0xff, 0xff, 0x6c, 0x03, 0x57, 0x33, 0x06, 0x02, 0x00, 0x00,
}
...
func (c *msgClient) UpdateParams(ctx context.Context, in *MsgUpdateParams, opts ...grpc.CallOption) (*MsgUpdateParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/coai.coai.Msg/UpdateParams", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_UpdateParams_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/coai.coai.Msg/UpdateParams",
	}
